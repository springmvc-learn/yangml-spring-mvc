...
public class Proxy {
	...
	public static Object newProxyInstance(Class infce) throws Exception{
		...
		String str =
		"package com.corejava.proxy.demo5;" + rt +
		...
		"}" ;
		//产生代理类的java文件
		String filename = System.getProperty("user.dir") +"/bin/com/corejava/proxy/demo5/$Proxy0.java";
		...
		Class c = cl.loadClass("com.corejava.proxy.demo5.$Proxy0");
